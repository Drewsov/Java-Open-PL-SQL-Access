...
// UDAV.IfHeader.java
//
// $Id: IfHeader.java,v 1.3 2005/01/13 11:38:18 Bob Exp $
//
//----------------------------------------------------------------------
...
public boolean match (String sResource, String sToken, String sETag)
{
  boolean b;
  if (this.hashRes != null) {
    if (this.hashRes.size() > 0) {
      ...
      while (enRes.hasMoreElements()) {
        ...
        if (sRes.equals("*") || sRes.endsWith(sResource)) {
              ...
              if (vecAnd != null) {
                ...
                while (enAnd.hasMoreElements()) {
                  ...
                  switch (entry.iMode & 0x01) {
                    case STATE_TOKEN:
                      b = b && (entry.sText.equals(sToken));
                      break;
                    case ENTITY_TAG:
                      b = b && (entry.sText.equals(sETag));
                      break;
                  }//switch
                }//while (enAnd)
              }//if (vecAnd)
